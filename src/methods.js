...
export default  function moveBallsAndDrawHoles (my_ball){
  ...
  // 
  my_ball.direction(); 
  if (my_ball.x_possition - my_ball.ball_size / 2 == hole1.y_possition - hole1.hole_size / 2 && my_ball.y_possition - my_ball.ball_size / 2 == hole1.y_possition - hole1.hole_size / 2)
  {
    alert ('bye');
  }
